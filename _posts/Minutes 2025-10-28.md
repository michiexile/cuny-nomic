...
#### Pull Request #126 Second Amendment
...
Beam calls the question for Pull Request #126 First Amendment
...
JH calls the question on Pull Request #126 Main motion
...
Beam calls the question on Pull request # 121 Main Motion
...
Beam calls the question on Pull Request #121 Third Amendment
...
Vote on Pull Request #121 Fifth Amendment
...
> If a rule change passes with an amendment, each adopted amendment to the rule change will award points to the player who introduced said amendment. The number of points that will be awarded, per adopted amendment, will be equal to 1000 points. This rule will not be applied to itself
